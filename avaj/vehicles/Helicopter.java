...
public class Helicopter extends Aircraft implements Flyable {
    ...
    public void updateConditions() {
        ...
        HashMap<String, String> weatherResponse = new HashMap<String, String>(){{
            put("SUN", "Damn the cockpit is heating up!");
            put("RAIN", "Some lovely rain!");
            put("FOG", "I can't see shit!");
            put("SNOW", "My rotor can't survive this weather!");
        }};
        ...
        System.out.println("Helicopter#" + this.name + "(" + this.id + "): " + weatherResponse.get(weather));
